class Line {
  constructor(data, { getQuote }) {
    this._id = data._id;
    this.data = data;
    this.sourceQuote = getQuote(data.sourceTurnId, data.sourceMarker);
    this.targetQuote = getQuote(data.targetTurnId, data.targetMarker);
  ...
  getSvgLine() {
    ...
    return `<path 
      ...
      line.y1
    }, ${line.x2 - k * (line.x2 - line.x1)} ${line.y2}, ${line.x2} ${line.y2}"
