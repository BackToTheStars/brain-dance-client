...
export const TurnsCollectionContext = createContext();
...
export const TurnsCollectionProvider = ({ children }) => {
  ...
  return (
    <TurnsCollectionContext.Provider value={value}>
      {children}
    </TurnsCollectionContext.Provider>
  );
};

export const useTurnsCollectionContext = () =>
  useContext(TurnsCollectionContext);
