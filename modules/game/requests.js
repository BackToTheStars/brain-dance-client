...
// Экспортируется ради сокета присутствия: отвергнутый им токен снимается тем же
// путём, что и на HTTP, а не своей копией этой логики.
export const dropBrokenAccess = (hash) => {
