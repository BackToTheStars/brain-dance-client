...
export const panels = [
  ...
  // Присутствие в игре: кто онлайн (левый столбец) и экскурсия — блок гида или
  // ведомого (правый). Открывается и закрывается вместе с переключателем Online
  // в панели Info; ничего не запоминает — online по умолчанию выключен при
  // каждой загрузке (без fieldsToSave). 480px — чтобы поле со ссылкой-
  // приглашением помещалось рядом со списком участников.
  {
    type: PANEL_PRESENCE,
    position: POSITION_FLEXIBLE,
